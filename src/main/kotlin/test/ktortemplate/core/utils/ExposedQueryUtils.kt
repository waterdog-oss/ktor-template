...
/**
 * Exposed framework utilities to construct queries automatically from user inputs
 */
object ExposedQueryUtils {
     ...
     */
    private fun Table.createFilters(filters: List<FilterField>): List<Op<Boolean>> {
